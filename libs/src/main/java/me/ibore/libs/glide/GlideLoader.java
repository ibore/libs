...
public class GlideLoader {
    ...
    private GlideImageViewListener glideImageViewListener;
    ...
    private void addProgressListener() {
        ...
        internalProgressListener = new ProgressListener() {
            @Override
    ...
    private void mainThreadCallback(final long bytesRead, final long totalBytes, final boolean isDone, final GlideException exception) {
        mMainThreadHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (glideImageViewListener != null) {
                    glideImageViewListener.onProgress(percent, isDone, exception);
                }
            }
        });
    }

    public void setGlideImageViewListener(String imageUrl, GlideImageViewListener glideImageViewListener) {
        this.mImageUrlObj = imageUrl;
        this.glideImageViewListener = glideImageViewListener;
        addProgressListener();
    }

    public void setProgressListener(String imageUrl, ProgressListener onProgressListener) {
        this.mImageUrlObj = imageUrl;
