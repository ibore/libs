...
public class StatusBarUtils {
    ...
    public static void translucent(Activity activity, @ColorInt int colorOn5x) {
        ...
        // 小米和魅族4.4 以上版本支持沉浸式
        if (MobileUtils.isMeizu() || MobileUtils.isMIUI()) {
...
//            }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        return MobileUtils.isMIUIV5() || MobileUtils.isMIUIV6() ||
                MobileUtils.isMIUIV7() || MobileUtils.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(MobileUtils.isZUKZ1() || MobileUtils.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (MobileUtils.isTablet(context)
                && sStatusbarHeight > SizeUtils.dp2px(STATUS_BAR_DEFAULT_HEIGHT_DP)) {
            //状态栏高度大于25dp的平板，状态栏通常在下方
            sStatusbarHeight = 0;
        } else {
            if (sStatusbarHeight <= 0
                    || sStatusbarHeight > SizeUtils.dp2px(STATUS_BAR_DEFAULT_HEIGHT_DP * 2)) {
