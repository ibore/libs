...
public final class AudioRecord {
    ...
    private AudioRecord(String dir) {
        mDirString = dir;
    }

    public static AudioRecord getInstance(String dir) {
        if (mInstance == null) {
            synchronized (AudioManager.class) {
                if (mInstance == null) {
                    mInstance = new AudioRecord(dir);
    ...
    public OnRecordListenter mListener;

    public void setOnAudioStageListener(OnRecordListenter listener) {
        mListener = listener;
    }
