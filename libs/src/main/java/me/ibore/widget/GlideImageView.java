 ...
 * description:
 * author: Ibore Xie
 * date: 2018/1/19 18:18
 * website: ibore.me
 * </pre>
 */
public class GlideImageView extends ShapeImageView {

    private GlideLoader mImageLoader;
    ...
    private void init() {
        mImageLoader = GlideLoader.create(this);
    }
    ...
    public GlideImageView listener(GlideImageViewListener listener) {
        getImageLoader().setGlideImageViewListener(getImageUrl(), listener);
        return this;
    }

    public GlideImageView listener(ProgressListener listener) {
        getImageLoader().setProgressListener(getImageUrl(), listener);
        return this;
    }
}
