...
class Utils {
    ...
    public static void savePlayPosition(Context context, String url, long position) {
        context.getSharedPreferences("X_VIDEO_PALYER_PLAY_POSITION",
    ...
    public static long getSavedPlayPosition(Context context, String url) {
        return context.getSharedPreferences("X_VIDEO_PALYER_PLAY_POSITION",
                Context.MODE_PRIVATE)
                .getLong(url, 0);
    }


    private static final String TAG = "XVideoPlayer";
