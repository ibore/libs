...
import me.ibore.social.SSOHandler;
...
import me.ibore.social.share.ShareMusicMedia;
import me.ibore.social.share.ShareWebMedia;
import me.ibore.social.util.BitmapUtils;
import me.ibore.social.util.LogUtils;
import me.ibore.social.util.NetUtils;
    ...
    public void authorize(Activity activity, AuthListener authListener) {
        ...
        this.mTencent.login(this.mActivity, "all", new IUiListener() {
            ...
            public void onComplete(Object o) {
                ...
                mAuthListener.onComplete(mConfig.getName(), NetUtils.jsonToMap(response));
